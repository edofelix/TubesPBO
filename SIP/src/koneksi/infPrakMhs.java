...
public class infPrakMhs extends javax.swing.JFrame {
public Statement st;
...
public DefaultTableModel dtmJdwl, dtmAspr, dtmRuang, dtmMk;
    ...
    private void initComponents() {
        ...
        tabAspr.setGridColor(new java.awt.Color(0, 0, 0));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(infPrakMhs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
